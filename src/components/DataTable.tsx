            ...
            {isEmpty(page) && (
              <tr>
                <td colSpan={headerGroups[0]?.headers?.length}>
                  {isEmpty(emptyComponent) ? <div className="flex items-center justify-center h-320">No data</div> : emptyComponent}
                </td>
              </tr>
            )}
              ...
              return (
                <tr
                  ...
                  className={classnames({
                    ...
                    [joinClassNames(['border-b border-innovasive-ui-border', rowClass])]: !rowOverride,
                  })}
                >
                  {row.cells.map(cell => (
                    <td
