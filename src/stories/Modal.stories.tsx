...
export const Default = () => {
  ...
  return (
    <div>
      ...
      <button onClick={() => setIsOpen(true)} className="px-16 py-8 text-white border rounded-3 bg-innovasive-ui-primary">
        Open modal
      </button>
    </div>
  )
...
export const Confirm = () => {
  ...
  return (
    <div>
      ...
      <ModalConfirm isOpen={isOpen} onCancel={() => setIsOpen(false)} onConfirm={() => setIsOpen(false)} />
      <button onClick={() => setIsOpen(true)} className="px-16 py-8 text-white border rounded-3 bg-innovasive-ui-primary">
        Open modal
      </button>
    </div>
