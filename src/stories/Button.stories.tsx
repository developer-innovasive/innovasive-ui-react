...
const TemplatePrimary: Story<ButtonPrimaryProps> = args => <ButtonPrimary {...args} />
...
const TemplateOutline: Story<ButtonOutlineProps> = args => <ButtonOutline {...args} />
...
Secondary.args = {
  ...
  title: () => (
    <div className="flex items-center space-x-8">
      ...
      <p className="subheading1">เพิ่มชื่อ</p>
    </div>
  ),
}
...
Ghost.args = {
  ...
  title: () => (
    <div className="flex items-center space-x-8">
      ...
      <p className="subheading1">เพิ่มหัวข้อ 2.2</p>
    </div>
  ),
}
...
export const OutlineLoading = TemplateOutline.bind({})
