...
var TextInput = function TextInput(_ref) {
  ...
  }, restProps, fields)), React__default.createElement("div", {
...
var Select = function Select(_ref) {
  ...
  return React__default.createElement("div", {
  ...
  }, isNoValue ? placeholder : value)), React__default.createElement("span", {
    ...
    return React__default.createElement("li", {
      ...
      className: classnames('h-40 flex items-center px-24 cursor-pointer bg-white', {
        'bg-innovasive-ui-options-selected hover:bg-innovasive-ui-options-selected': lodash.isEqual(value, o.value),
        'hover:bg-innovasive-ui-options-hover': !lodash.isEqual(value, o.value)
      })
    }, React__default.createElement("span", {
      className: classnames({
        'inno-options-small': textSize === 'small',
...
var ButtonPrimary = function ButtonPrimary(_ref) {
  ...
  var id = _ref.id,
      ...
      disabled = _ref.disabled,
      onClick = _ref.onClick;
  return React__default.createElement(ButtonBase, {
    id: id,
    disabled: disabled,
    onClick: onClick,
...
function joinClassNames(classes) {
  return lodash.filter(classes).join(' ');
}
...
var DataTable = function DataTable(options) {
  ...
  */
  ...
  return React__default.createElement("div", null, React__default.createElement("div", {
    ...
    className: "bg-white"
  }), lodash.isEmpty(page) && React__default.createElement("tr", null, React__default.createElement("td", {
  ...
  }, lodash.isEmpty(emptyComponent) ? React__default.createElement("div", {
  ...
  })))), pageCount > 0 && React__default.createElement("div", {
